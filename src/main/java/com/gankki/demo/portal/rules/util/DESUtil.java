...
public class DESUtil {
    ...
    public static void main(String[] args) {
        try {
            ...
            System.out.println("加密后的字符：" + des1.encrypt(test1));  //4be44ddc40552199
            System.out.println("解密后的字符：" + des1.decrypt(des1.encrypt(test1)));

            String test2 = "wpsbind";
            DESUtil des2 = new DESUtil("jiake");// 自定义密钥  
            System.out.println("加密前的字符：" + test2);
            System.out.println("加密后的字符：" + des2.encrypt(test2));  //979832cdc2441c6b
