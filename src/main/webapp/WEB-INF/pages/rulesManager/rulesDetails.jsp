...
<div class="content-main">
    ...
    <div class="content-body">
        <form action="<%=request.getContextPath()%>/rules/regulation/update" method="post" id="rulesInf"
              enctype="multipart/form-data">
            <input type="hidden" name="id" value="${rule.id }" readonly="readonly">
            <div class="row">
                <div class="col-xs-12">
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input class="form-control" onBlur="if(this.value=='') this.placeholder='此处必填';" type="text"
                                   id="theme1" name="theme" value="${rule.theme }"/>
                        </div>
                        <div class="col-sm-1">
            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <select class="form-control" id="product_type" name="productType"
                                    style="background: url('<%=request.getContextPath()%>/images/select.png')
                                            no-repeat scroll  99% center transparent;">
                                <c:forEach items="${productType1 }" var="map">
                                    <c:if test="${map.key == rule.productType }">
            ...
            <div class="row" style="margin-left:-9px;">
                <div class="col-xs-6">
                    <div class="form-group">
                        ...
                        <div class='col-sm-7'>
                            <input type="text" class="form-control" id="buildDate1" name="buildDate"
                                   value="<fmt:formatDate value='${rule.buildDate }' pattern='yyyy-MM-dd'/>"/>
                        </div>
                    </div>
                </div>
                <div class="col-xs-6">
                    <div class="form-group" style="margin-left:-10px;">
                        ...
                        <div class='col-sm-7'>
                            <input type="text" class="form-control" id="buildPerson1" name="buildPerson"
                                   value="${rule.buildPerson }"/>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <a href="javascript:;" class="a-upload">
                                <input type="file" name="file">更改上传文件
                            </a><span class="showFileName">&nbsp;&nbsp;&nbsp;${rule.rules }</span>
                            <input type="hidden" name="rules" value="${rule.rules }">
                        </div>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-xs-12">
                    <div class="form-group">
                        ...
                        <div class='col-sm-9'>
                            <textarea id="introduce" class="form-control" name="introduce"
                                      style="height:120px;">${rule.introduce }</textarea>
                        </div>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-xs-12">
                    <div class="form-group">
                        ...
                        <div class='col-sm-9'>
                            <textarea id="remarks1" class="form-control" name="remarks"
                                      style="height:120px;">${rule.remarks }</textarea>
                        </div>
                    </div>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-xs-4">
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <button class="col-sm-6 btn btn-succes" type="button" onclick="return validat();">提交
                            </button>
                        </div>
                    </div>
                </div>
